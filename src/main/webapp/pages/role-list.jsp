								...
								<c:forEach items="${requestScope.roles}" var="role">
									<tr>
										...
										<td class="text-center">
											<a href="${pageContext.request.contextPath}/queryByID/${role.id}" class="btn bg-olive btn-xs">详情</a>
											<a href="${pageContext.request.contextPath}/del-role-Id/${role.id}" class="btn bg-olive btn-xs">删除角色</a>
											<a href="${pageContext.request.contextPath}/role/findallpermission/${role.id}" class="btn bg-olive btn-xs">添加权限</a>
										</td>
									</tr>
								</c:forEach>
								</tbody>
