								...
								<c:forEach items="${permissions}" var="permission">
									<tr>
										...
										<td class="text-center">
											<a href="${pageContext.request.contextPath}/findpermissionByid/${permission.id}" class="btn bg-olive btn-xs">详情</a>
											<a href="${pageContext.request.contextPath}/delpermission/${permission.id}" class="btn bg-olive btn-xs">删除权限</a>
										</td>
									</tr>
								</c:forEach>
