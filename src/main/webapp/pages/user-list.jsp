							...
							<table id="dataList"
								...
								<c:forEach items="${requestScope.users}" var="user">
									<tr>
										...
										<td>未开启</td>
										<td class="text-center">
											<a href="${pageContext.request.contextPath}/queryByuid/${user.id}" class="btn bg-olive btn-xs">详情</a>
											<a href="${pageContext.request.contextPath}/user-role-add/${user.id}" class="btn bg-olive btn-xs">添加角色</a>
										</td>
									</tr>
								</c:forEach>
